<template>
  ...
  <q-form action="" @submit="onSubmit">
    ...
    <LoginButtonComponent :label="'Zaloguj się'" style="margin-top: 20px;" />
  </q-form>
</template>
<script setup>
import LoginButtonComponent from "src/components/shared/ButtonComponent.vue";
